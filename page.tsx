...
const chapters = [
  { number: "01", label: "INTRO", eyebrow: "APPLICATION SUPPORT • PLATFORM OPERATIONS", title: "Hanuman Pradeepraj", subtitle: "Application Support & Platform Operations Engineer", text: "Solving complex technical challenges • Customer-focused operations • Cloud • Observability • Performance • AI", },
  { number: "02", label: "WHO I AM", eyebrow: "WHO I AM", title: "Keeping technology reliable", subtitle: "Support, operations and problem solving", text: "I enjoy solving complex technical challenges and helping customers keep their applications running reliably across enterprise environments.", },
  { number: "03", label: "CAREER JOURNEY", eyebrow: "2008 → 2026", title: "A journey across technology", subtitle: "Development → Application Engineering → Operations → AI", text: "A career that evolved from software development into application support, eDiscovery and cloud operations, observability, performance engineering and an increasing focus on AI.", },
  { number: "04", label: "ACHIEVEMENTS", eyebrow: "TOP CAREER ACHIEVEMENTS", title: "Turning problems into improvements", subtitle: "Performance • Reliability • Customer Experience", text: "Performance optimization, API processing, transaction performance, memory optimization, SQL tuning, cloud efficiency, alert reduction and monitoring improvements.", },
  { number: "05", label: "EXPERIENCE", eyebrow: "EXPERIENCE", title: "Enterprise platforms. Production responsibility.", subtitle: "ServiceNow • OpenText • Pramati Technologies • Virtusa", text: "Experience across application operations, production support, cloud operations, incident management, problem management, RCA, monitoring and platform reliability.", },
  { number: "06", label: "TECHNOLOGY", eyebrow: "TECHNOLOGY", title: "The tools behind the work", subtitle: "Cloud • Code • Observability • IT Operations", text: "AWS • Python • SQL • REST APIs • ServiceNow • Splunk • SolarWinds • PagerDuty • Icinga • SRE • ITIL", },
  { number: "07", label: "AI", eyebrow: "AI JOURNEY", title: "Growing toward intelligent operations", subtitle: "AI-Assisted Monitoring • Predictive Intelligence • Generative AI • Agentic AI", text: "Exploring how AI can strengthen operational visibility, identify patterns, support decision-making and enable smarter automation.", },
  { number: "08", label: "EDUCATION", eyebrow: "EDUCATION", title: "Always learning", subtitle: "Generative AI • Agentic AI • Project Management • Information Technology", text: "Illinois Institute of Technology — PGP in Generative AI & Agentic AI • ISB — Project Management Certificate • JNTU — B.Tech IT", },
  { number: "09", label: "CONTACT", eyebrow: "LET'S CONNECT", title: "Let's build something reliable.", subtitle: "N H Pradeepraj", text: "Application Support & Platform Operations Engineer • Hyderabad, India", },
];
...
export default function Home() {
  ...
  const startExperience = async () => {
    ...
    // This click is the user gesture that unlocks audio/video playback.
  ...
  const toggleSound = async () => {
    ...
    try {
      ...
      if (introVideoRef.current && active === 0) {
        introVideoRef.current.muted = false;
  ...
  return (
    <main className={`stage ${started ? "is-started" : "is-intro"} scene-${active} ${transitioning ? "is-transitioning" : ""}`}
      ...
      <div className="v9-ambient" aria-hidden="true">
        <div className="space-dots" aria-hidden="true">{Array.from({ length: 96 }, (_, i) => <span key={i} style={{ "--dot-i": i, left: `${(i * 37 + 7) % 100}%`, top: `${(i * 61 + 11) % 100}%`, "--dot-size": `${1 + ((i * 17) % 4) * .45}px`, "--dot-opacity": `${0.18 + ((i * 23) % 7) * .08}` } as React.CSSProperties} />)}</div>
      ...
      <header className="topbar">
        <div className="brand brand-logo"><img src="/portfolio-logo.png" alt="Pradeepraj's Portfolio" /></div>
      ...
      <section className="content">
        <div className={`copy ${transitioning ? "copy-out" : "copy-in"} scene-copy-${active}`}>
          <h1 className={`scene-title scene-title-${active}`}>{active === 0 ? <>N H <span className="outline">Pradeepraj</span></> : chapters[active].title}</h1>
